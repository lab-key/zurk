...
const SUBMODULE_URL = "https://github.com/lab-key/universal-robots-kinematics";
const SUBMODULE_BRANCH = "zurk";
const SUBMODULE_PATH = "libs/upstream/universal-robots-kinematics";
const VENDOR_PATH = "libs/universal-robots-kinematics";
